        ...
        {Object.entries(posts)
          ...
          .map(([year, yearArticles]) => (
            <div key={year} className="relative">
              <time
                dateTime={year}
                className="font-monoton absolute -left-8 md:-left-4 top-0 text-[6rem] md:text-[8rem] font-bold text-foreground/10 leading-none pointer-events-none select-none"
              >
                {year}
              </time>
